...
<div id="content-header">
  <div id="breadcrumb"> <a href="<?php echo e(route('dashboard')); ?>" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Home</a> <a href="#" class="current">Dstv</a> </div>
...
<div class="widget-box">
        ...
        <div class="widget-content nopadding">
          <form action="<?php echo e(route('dstv')); ?>" method="post" class="form-horizontal" id="dstv">
            <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.backend.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\mywebsites\rechargeme\resources\views/pages/backend/dstv.blade.php ENDPATH**/ ?>