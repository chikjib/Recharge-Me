    ...
    <footer>
            ...
            <div class="footer-text">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-4 col-lg-4 col-md-4 col-12">
                        ...
                        ?>
                        <?php if($postsfooter): ?>
                        <?php $__currentLoopData = $postsfooter; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $postfooter): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="media">
                            <img class="media-object rounded-circle mr-3" src="<?php echo e(asset('front/images/logo.png')); ?>"
                                alt="image">
                            <div class="media-body">
                                <p class="media-heading text-justify"><?php echo illuminate\Support\Str::words($postfooter->body, 50, '...'); ?></p>
                                <p class="text-right"><i><?php echo e($postfooter->author); ?></i></p>
                            </div>
                        </div>
        ...
        <div class=" col-12 copyright">
            <div class="container">
                <p>Copyright &copy; Josh Admin Template, <?php echo e(date('Y')); ?></p>
            </div>
        </div>
    </footer>
    ...
    <!--global js starts-->
    <script type="text/javascript" src="<?php echo e(asset('front/js/frontend/lib.js')); ?>"></script>
    <!--global js end-->
    <!-- begin page level js -->
    <!-- page level js starts-->
<script type="text/javascript" src="<?php echo e(asset('front/js/frontend/jquery.circliful.js')); ?>"></script>
<script type="text/javascript" src="<?php echo e(asset('front/vendors/wow/js/wow.min.js')); ?>"></script>
<script type="text/javascript" src="<?php echo e(asset('front/vendors/owl_carousel/js/owl.carousel.min.js')); ?>"></script>
<script type="text/javascript" src="<?php echo e(asset('front/js/frontend/carousel.js')); ?>"></script>
<script type="text/javascript" src="<?php echo e(asset('front/js/frontend/index.js')); ?>"></script>
<!--page level js ends-->
    <!-- end page level js -->
    <script>
...
</html><?php /**PATH C:\xampp\htdocs\mywebsites\rechargeme\resources\views/layouts/frontend/footer.blade.php ENDPATH**/ ?>